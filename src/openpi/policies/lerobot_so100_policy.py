...
def make_so100_example() -> dict:
    ...
    return {
        ...
        "observation/images/laptop": np.random.randint(256, size=(480, 640, 3), dtype=np.uint8),
        "observation/images/phone": np.random.randint(256, size=(480, 640, 3), dtype=np.uint8),
        "prompt": "do something",
    }
...
class so100Inputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        base_image = _parse_image(data["observation/images/laptop"])
        wrist_image = _parse_image(data["observation/images/phone"])
